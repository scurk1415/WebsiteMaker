...
class _View_ErrorComponent_Host0 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    this._el_0 = this.selectOrCreateHostElement('dip-error',rootSelector,(null as any));
    ...
    this._appEl_0.initComponent(this._ErrorComponent_0_4,([] as any[]),compView_0);
...
function viewFactory_ErrorComponent_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_ErrorComponent_Host === (null as any))) { (renderType_ErrorComponent_Host = viewUtils.createRenderComponentType('',0,import9.ViewEncapsulation.None,([] as any[]),{})); }
  return new _View_ErrorComponent_Host0(viewUtils,parentInjector,declarationEl);
}
export const ErrorComponentNgFactory:import10.ComponentFactory<import3.ErrorComponent> = new import10.ComponentFactory<import3.ErrorComponent>('dip-error',viewFactory_ErrorComponent_Host0,import3.ErrorComponent);
const styles_ErrorComponent:any[] = [import11.styles];
...
class _View_ErrorComponent0 extends import1.AppView<import3.ErrorComponent> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_0:any = this.context.displayError;
...
export function viewFactory_ErrorComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.ErrorComponent> {
  if ((renderType_ErrorComponent === (null as any))) { (renderType_ErrorComponent = viewUtils.createRenderComponentType('',0,import9.ViewEncapsulation.Emulated,styles_ErrorComponent,{})); }
...
class _View_ErrorComponent1 extends import1.AppView<any> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    this.detectContentChildrenChanges(throwOnChange);
    const currVal_0:any = import4.interpolate(1,'',this.parent.context.errorData.title,'');
    if (import4.checkBinding(throwOnChange,this._expr_0,currVal_0)) {
