...
var _View_AppComponent_Host0 = (function (_super) {
    ...
    _View_AppComponent_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('dip-app', rootSelector, null);
...
export var AppComponentNgFactory = new import9.ComponentFactory('dip-app', viewFactory_AppComponent_Host0, import3.AppComponent);
...
var _View_AppComponent0 = (function (_super) {
    ...
    _View_AppComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_4 = this.renderer.createElement(this._el_2, 'dip-header', null);
        this._appEl_4 = new import2.AppElement(4, 2, this, this._el_4);
        var compView_4 = import12.viewFactory_HeaderComponent0(this.viewUtils, this.injector(4), this._appEl_4);
        ...
        this._el_7 = this.renderer.createElement(this._el_0, 'main', null);
        this.renderer.setElementAttribute(this._el_7, 'class', 'main-wrapper');
        this._text_8 = this.renderer.createText(this._el_7, '\n        ', null);
        this._el_9 = this.renderer.createElement(this._el_7, 'router-outlet', null);
        this._appEl_9 = new import2.AppElement(9, 7, this, this._el_9);
        this._RouterOutlet_9_5 = new import11.RouterOutlet(this.parentInjector.get(import15.RouterOutletMap), this._appEl_9.vcRef, this.parentInjector.get(import16.ComponentFactoryResolver), null);
    ...
    _View_AppComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import10.HeaderComponent) && (4 === requestNodeIndex))) {
            return this._HeaderComponent_4_4;
        }
        if (((token === import11.RouterOutlet) && (9 === requestNodeIndex))) {
            return this._RouterOutlet_9_5;
        }
        return notFoundResult;
    };
