...
import * as import11 from './error.component.css.shim';
...
var _View_ErrorComponent_Host0 = (function (_super) {
    ...
    _View_ErrorComponent_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('dip-error', rootSelector, null);
...
export var ErrorComponentNgFactory = new import10.ComponentFactory('dip-error', viewFactory_ErrorComponent_Host0, import3.ErrorComponent);
var styles_ErrorComponent = [import11.styles];
...
var _View_ErrorComponent0 = (function (_super) {
    ...
    _View_ErrorComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this.renderer.setElementAttribute(this._el_0, 'id', 'error-panel');
        this._text_1 = this.renderer.createText(this._el_0, '\n    ', null);
        this._anchor_2 = this.renderer.createTemplateAnchor(this._el_0, null);
        this._appEl_2 = new import2.AppElement(2, 0, this, this._anchor_2);
        this._TemplateRef_2_5 = new import13.TemplateRef_(this._appEl_2, viewFactory_ErrorComponent1);
    ...
    _View_ErrorComponent0.prototype.detectChangesInternal = function (throwOnChange) {
        var currVal_0 = this.context.displayError;
...
export function viewFactory_ErrorComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_ErrorComponent === null)) {
        (renderType_ErrorComponent = viewUtils.createRenderComponentType('', 0, import9.ViewEncapsulation.Emulated, styles_ErrorComponent, {}));
    }
    return new _View_ErrorComponent0(viewUtils, parentInjector, declarationEl);
}
var _View_ErrorComponent1 = (function (_super) {
    __extends(_View_ErrorComponent1, _super);
    function _View_ErrorComponent1(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_ErrorComponent1, renderType_ErrorComponent, import6.ViewType.EMBEDDED, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_ErrorComponent1.prototype.createInternal = function (rootSelector) {
        ...
        this.renderer.setElementAttribute(this._el_2, 'class', 'error-text');
    ...
    _View_ErrorComponent1.prototype.detectChangesInternal = function (throwOnChange) {
        this.detectContentChildrenChanges(throwOnChange);
        var currVal_0 = import4.interpolate(1, '', this.parent.context.errorData.title, '');
        if (import4.checkBinding(throwOnChange, this._expr_0, currVal_0)) {
    ...
    return _View_ErrorComponent1;
}(import1.AppView));
function viewFactory_ErrorComponent1(viewUtils, parentInjector, declarationEl) {
