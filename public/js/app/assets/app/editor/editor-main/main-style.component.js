...
export var MainStyleComponent = (function () {
    function MainStyleComponent() {
        this.font_sizes = [];
        this.paddings = [];
        this.layoutTypes = MainLayoutTypes;
    }
    MainStyleComponent.prototype.ngOnInit = function () {
        this.font_sizes = [
    ...
    /** @nocollapse */
    MainStyleComponent.ctorParameters = [];
    MainStyleComponent.propDecorators = {
        'main': [{ type: Input },],
    };
