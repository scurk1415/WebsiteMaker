...
var AppModuleInjector = (function (_super) {
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_EventManager_22", {
        get: function () {
            if ((this.__EventManager_22 == null)) {
                (this.__EventManager_22 = new import15.EventManager(this._EVENT_MANAGER_PLUGINS_21, this.parent.get(import39.NgZone)));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_LocationStrategy_43", {
        get: function () {
            if ((this.__LocationStrategy_43 == null)) {
                (this.__LocationStrategy_43 = import7.provideLocationStrategy(this.parent.get(import41.PlatformLocation), this.parent.get(import42.APP_BASE_HREF, null), this._ROUTER_CONFIGURATION_42));
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_APP_BOOTSTRAP_LISTENER_55", {
        get: function () {
            if ((this.__APP_BOOTSTRAP_LISTENER_55 == null)) {
                (this.__APP_BOOTSTRAP_LISTENER_55 = [import7.initialRouterNavigation(this._Router_49, this._ApplicationRef_16, this._RouterPreloader_53, this._ROUTER_CONFIGURATION_42)]);
            }
    ...
    Object.defineProperty(AppModuleInjector.prototype, "_AppService_56", {
        get: function () {
            if ((this.__AppService_56 == null)) {
                (this.__AppService_56 = new import32.AppService(this._Http_41));
            }
    ...
    AppModuleInjector.prototype.createInternal = function () {
        ...
        this._ROUTER_FORROOT_GUARD_5 = import7.provideForRootGuard(this.parent.get(import44.Router, null));
        ...
        this._ApplicationRef__15 = new import12.ApplicationRef_(this.parent.get(import39.NgZone), this.parent.get(import45.Console), this, this._ErrorHandler_12, this, this._ApplicationInitStatus_13, this.parent.get(import11.TestabilityRegistry, null), this._Testability_14);
    ...
    AppModuleInjector.prototype.getInternal = function (token, notFoundResult) {
        ...
        if ((token === import47.ErrorHandler)) {
        ...
        if ((token === import56.NgModuleFactoryLoader)) {
            return this._NgModuleFactoryLoader_47;
        }
        if ((token === import57.ROUTES)) {
            return this._ROUTES_48;
        }
        if ((token === import44.Router)) {
            return this._Router_49;
        }
        if ((token === import58.ActivatedRoute)) {
        ...
        if ((token === import32.AppService)) {
            return this._AppService_56;
        }
